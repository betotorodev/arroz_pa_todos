...
export const Introduction = () => {
  return (
    <section className="introduction">
      ...
      <div className="box-1">
        <h1>Hagamos Vaca</h1>
        <p>Apóyanos con tu donación y hagamos rendir el arroz para más familias.
      ...
      <div className="box-2">
        <h1>Cocinemos</h1>
        <p>Queremos repartir +5.000 arroces en la segunda etapa y tú puedes ayudarnos.
      ...
      <div className="box-3">
        <h1>Conoce Más</h1>
        <p>Llegamos a las poblaciones de mayor necesidad, con ayuda de distribuidores  y entidades aliadas.
